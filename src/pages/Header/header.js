    ...
    return (
        ...
        <img src={logo} alt="Logo" />
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/YunithYT" target="_blank">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/yunith-k-282b9b297?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
...
<p>LinkedIn</p>
                ...
                <a className="twitter" href="https://x.com/KYunith83552?t=q29ewx_Om0Kx9jLFCg1o8w&s=08" target="_blank">
...
<p>Twitter</p>
                ...
                <a className="schedule" href="https://www.instagram.com/___.mr_mystic_seeker_?utm_source=qr&igsh=ZzZheGNiN2J6OWpt" target="_blank">
                <div className="schedule_box">
                   <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M24 4C13.5066 4 5 12.5066 5 23C5 33.4934 13.5066 42 24 42C34.4934 42 43 33.4934 43 23C43 12.5066 34.4934 4 24 4ZM31.5 16C32.3284 16 33 15.3284 33 14.5C33 13.6716 32.3284 13 31.5 13C30.6716 13 30 13.6716 30 14.5C30 15.3284 30.6716 16 31.5 16ZM24 17.5C20.4101 17.5 17.5 20.4101 17.5 24C17.5 27.5899 20.4101 30.5 24 30.5C27.5899 30.5 30.5 27.5899 30.5 24C30.5 20.4101 27.5899 17.5 24 17.5ZM24 28.5C21.5147 28.5 19.5 26.4853 19.5 24C19.5 21.5147 21.5147 19.5 24 19.5C26.4853 19.5 28.5 21.5147 28.5 24C28.5 26.4853 26.4853 28.5 24 28.5ZM34 16.4C34 14.6118 32.3882 13 30.6 13H17.4C15.6118 13 14 14.6118 14 16.4V29.6C14 31.3882 15.6118 33 17.4 33H30.6C32.3882 33 34 31.3882 34 29.6V16.4ZM17.4 15H30.6C31.3721 15 32 15.6279 32 16.4V29.6C32 30.3721 31.3721 31 30.6 31H17.4C16.6279 31 16 30.3721 16 29.6V16.4C16 15.6279 16.6279 15 17.4 15Z"
      fill="#E1306C" />
  </svg>
<p>Instagram</p>
                </div>
